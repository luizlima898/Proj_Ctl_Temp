...
app.post('/update-sensor', (req, res) => {
    ...
    db.query(sql, [temperatura, luminosidade], (err, result) => {
...
//  Rota que o Dashboard chama ao clicar no botão
